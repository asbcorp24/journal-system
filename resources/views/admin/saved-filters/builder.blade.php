            ...
            <form class="card" id="savedFilterForm">
                <div class="card-body">
                    ...
                    <div class="text-secondary small mb-3">
                        Отметьте поля, которые должны показываться в админских фильтрах, и при необходимости задайте значения по умолчанию.
                    </div>
...
@push('scripts')
    <script>
        ...
        $('#deleteSavedFilterBtn').on('click', function () {
            ...
            if (!id || !confirm('Удалить сохранённый фильтр?')) {
                return;
            }
